...
function launchBot() {
    ...
    try {
        console.log(chalk.blue('🌐 Loading pairing website...'));
        require('./server');
        console.log(chalk.green('✅ Pairing website ready!'));
    } catch (error) {
        console.log(chalk.red('❌ Failed to load pairing website:', error.message));
    }
