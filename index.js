...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('ɴᴇxᴜs-ᴍᴅx ʙᴏᴛ ᴀᴄᴛɪᴠᴇ', {
        font: 'Standard',
    ...
    console.log(chalk.green('ɴᴇxᴜs-ᴍᴅx'));
...
function launchBot() {
    console.clear();
    console.log(chalk.blue('ɴᴇxᴜs-ᴍᴅx ᴍᴇ ᴀʟʟ....\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.blue('✅ ɴᴇxᴜs-ᴍᴅx ɪs sᴜᴄᴄᴇssғᴜʟʟʏ ᴀᴄᴛɪᴠᴇ'));
        } catch (error) {
    ...
    console.log(telegramLoaded ? chalk.green( '✅ ɴᴇxᴜs-ᴍᴅx : ᴀᴄᴛɪᴠᴇ ') : chalk.red('❌ ɴᴇxᴜs-ᴍᴅx'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ ɴᴇxᴜs-ᴍᴅx ɪs ᴀᴄᴛɪᴠᴇ!\n'));
    }
